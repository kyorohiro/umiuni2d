...
enum CanvasElementTextAlign { left_top, left_center, center_top, center_center, }
...
class CanvasElementText {
  ...
  static html.CanvasElement makeImage(String message, {TinyColor fillColor: null, TinyColor strokeColor: null, num fontsize: 25, bool isBold: false, bool isItalic: false, String fontFamily: "Century Gothic", int height: 300, int width: 300, html.CanvasElement canvasElm: null, CanvasElementTextAlign align: CanvasElementTextAlign.center_center, bool resizeHeight: true}) {
    ...
    html.CanvasRenderingContext2D context = resetCanvasImage(fontSize: fontsize, isBold: isBold, isItalic: isItalic, fontFamily: fontFamily, fillStyle: fillColor, strokeStyle: strokeColor, textureHeight: height, textureWidth: width, canvasElm: canvasElm);
...
class TextLines {
  ...
  TextLines.fromContext2D(html.CanvasRenderingContext2D context, String messages, int width, int fontHeight) {
    _width = 0;
    _height = 0;
    List<String> m = messages.split("\n");
    for (String message in m) {
